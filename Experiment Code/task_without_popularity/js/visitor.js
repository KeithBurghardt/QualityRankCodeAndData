...
//alert("Is this working??");
                ...
                $("#msgbox").removeClass().addClass('messagebox').text('Loading Data...').fadeIn(1000);
                $.ajax({
                     type: "POST",
                     url: "user_start.php",
                        	...
                        	$("#msgbox").fadeTo(200,0.1,function()  //start fading the messagebox
			        {
			                  ...
			                  $(this).html('Loaded successfully!').addClass('messageboxok').fadeTo(900,1,
			                  function()
			                  {
			 ...
			 {//window.alert(msg);
                            ...
                            $("#msgbox").fadeTo(200,0.1,function() {
                              //add message and change the class of the box and start fading
                              $(this).html('Loading failed...').addClass('messageboxerror').fadeTo(900,1);
	    	         	});
			 }
  ...
  $("#answer-btn").click(function() {
                ...
                //remove all the class add the messagebox classes and start fading
                $("#msgbox").removeClass().addClass('messagebox').text('Loading Stories...').fadeIn(1000);
                $.ajax({
                     type: "POST",
                     ...
                     success: function(msg) {
                        if(msg == "success")
                        {
                                ...
                                {
                                          //add message and change the class of the box and start fading
                                          $(this).html('Loading successfully....').addClass('messageboxok').fadeTo(900,1,
                                          function()
                                          {
                                            //redirect to story browse page
                                            window.location.href = 'story_browse.php';
